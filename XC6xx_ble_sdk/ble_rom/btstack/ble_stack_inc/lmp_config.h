 ...
 * CREATION DATE:        
 *
 * SOURCE CONTROL: $Id: lmp_config.h,v 1.121 2014/03/11 03:14:05 garyf Exp $
 *
 * LICENSE:
...
#if 0//(PRH_BS_CFG_SYS_LMP_ECC256_SUPPORTED==1)
	u_int8 public_key_x256[32];
	u_int8 public_key_y256[32];
	u_int8 secret_key256[32];
#endif

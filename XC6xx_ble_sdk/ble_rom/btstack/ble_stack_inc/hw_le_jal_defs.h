...
#define JAL_LE_FILTER_ADDR         (0x00000060 + JAL_LE_BASE_ADDR)
#define JAL_LE_IMMEDIATE_ADDR      (0x00000090 + JAL_LE_BASE_ADDR)      
#define JAL_LE_TARGET_ADDR         (0x00000098 + JAL_LE_BASE_ADDR)   

#define JAL_LE_RX_CONTROL_REG      (0x00000058 + JAL_LE_BASE_ADDR)

#define JAL_LE_IMMEDIATE_FILTER_TX_ADDR_TYPE_ADDR (0x00000094 + JAL_LE_BASE_ADDR)
#define JAL_LE_IMMEDIATE_FILTER_TX_ADDR_TYPE_MASK 0x40000000
#define JAL_LE_IMMEDIATE_FILTER_TX_ADDR_TYPE_SHFT 22

#define JAL_LE_TARGET_ADDRESS_RX_ADDR_TYPE_ADDR (0x00000098 + 4 + JAL_LE_BASE_ADDR)

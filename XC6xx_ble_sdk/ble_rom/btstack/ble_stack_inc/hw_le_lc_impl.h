 ...
 * DATE:           July 2011
 *
 * SOURCE CONTROL: $Id: hw_le_lc_impl.h,v 1.5 2014/03/11 03:13:38 garyf Exp $
 *
 * LICENSE:
...
__INLINE__ void HWle_set_rx_mode(u_int rx_mode)							{ mSetHWEntry(JAL_LE_RX_MODE,rx_mode);}  //LE_FILTER_MODE /*0: Legacy mode,no filtering 1:  Active Scanning    2: Passive Scanning   3: advertising state  4:Initiating   5: connect*/
...
#endif
#define  BTPHY_SYNCWORD     	((volatile unsigned *)(0x4002C000+0x248))
__INLINE__ void HWle_set_acc_addr(const u_int acc_addr)                    {mSetHWEntry(JAL_LE_ACC_ADDR,acc_addr);
																					*BTPHY_SYNCWORD = acc_addr;}//config modem register at the same time gwh 

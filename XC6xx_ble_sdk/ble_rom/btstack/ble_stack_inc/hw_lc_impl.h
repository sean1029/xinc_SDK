 ...
 * DATE:           1 Jun 1999
 *
 * SOURCE CONTROL: $Id: hw_lc_impl.h,v 1.139 2013/10/08 16:46:17 tomk Exp $
 *
 * LICENSE:
 ...
 * RECEIVE CONTROL REGISTERS
 ...
 01: receive mode // 20 |━s receive window centred 625 us after the start of each transmit slot
 10: for page mode  //
     When SLAVE=0, a 20 us receive window is centred 625 |━s and 937 |━s after the start of each 	transmit slot.
	 When SLAVE=1, a 20 us receive window is centred 312 us and 625 |━s after the start of each  transmit slot.
 11: full rx mode?♀ 
 //The receive window is permanently enabled, thereby allowing reception of packets not coincident 	with the Bluetooth slot boundaries.
 */
/* Set RX Mode Bits */

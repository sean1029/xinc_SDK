...
#else
#define LSLCstat_Inc_Valid_Packet_Cntr()      
#define LSLCstat_Inc_Invalid_Packet_Cntr()    
#define LSLCstat_Inc_Rx_No_Packet_Cntr()        
#define LSLCstat_Inc_HEC_Error_Cntr()          
#define LSLCstat_Inc_CRC_Error_Cntr()          
#define LSLCstat_Inc_Rx_Duplicate_Cntr()  

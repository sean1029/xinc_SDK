 ...
 *
 * SOURCE CONTROL: $Id: tra_hcit.h,v 1.30 2011/05/17 16:18:32 tomk Exp $
 *
 * LICENSE:
...
t_error TRAhcit_Register_Generic_Dispatcher(u_int32 (*callback)(u_int8 *data, u_int32 pdu_len, u_int8 *header, 
                            u_int8 head_len));

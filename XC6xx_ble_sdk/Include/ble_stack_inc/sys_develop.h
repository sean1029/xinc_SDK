 ...
 * Expiry:        
 */
#define    PRH_BS_DEV_ADOPT_ERRATUM_E2088    0
...
#define LMP_SLOT_GAURD_FOR_CHANGE_PICONET 8 //0x10

#define SYS_CFG_MIN_SLOTS_FOR_SLEEP_PROCEDURE 28	 // 32
#define SYS_CFG_LE_LC_MIN_SLOTS_FOR_SLEEP_PROCEDURE (32)
...
#define SYS_CFG_LE_SLEEP_ACTIVE_CONNECTIONS 0

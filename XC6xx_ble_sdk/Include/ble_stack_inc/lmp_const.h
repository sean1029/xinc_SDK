 ...
 *
 * SOURCE CONTROL:  $Id: lmp_const.h,v 1.122 2013/10/25 16:48:20 tomk Exp $ 
 *    
 **************************************************************************/
...
#endif
#define DEFAULT_INQUIRY_SCAN_WINDOW         0x0012   /*      */
...
#define PRH_BS_PICONET_SERVICE_TIME ((2*DEFAULT_T_POLL) + LMP_SLOT_GAURD_FOR_CHANGE_PICONET)

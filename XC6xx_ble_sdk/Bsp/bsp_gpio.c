...
/*CPR_GPIO_FUN_SEL1*/.fun_sel1.bits.b0004= GPIO_Dx,/*GPIO 4*/.fun_sel1.bits.b0812= GPIO_Dx,/*GPIO 5*/.fun_sel1.bits.b1620= GPIO_Dx,/*SSI1_RX 6*/.fun_sel1.bits.b2428= SSI1_TX,/*GPIO 7*/    
...
- 创建日期: 2016-05-26
----------------------------------------------------------------------------------------------------*/
void	gpio_Register_Callback(IoHandler_callback callback)
{
...
- 创建日期: 2016-06-07
----------------------------------------------------------------------------------------------------*/
uint8_t gpio_input_val(uint8_t num)
{
		uint32_t val;	
...
- 创建日期: 2016-06-07
----------------------------------------------------------------------------------------------------*/
void	gpio_direction_output(uint8_t num)
{
...
- 创建日期: 2016-06-07
----------------------------------------------------------------------------------------------------*/
void		gpio_direction_input(uint8_t num, uint8_t pull_up_type)
{

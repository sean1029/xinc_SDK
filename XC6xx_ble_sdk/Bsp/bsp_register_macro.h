...
#define		RTC_AO_TIMER_CTL					((volatile unsigned *)(RTC_BASE + 0x0040))
#define		RTC_AO_GPIO_MODE					((volatile unsigned *)(RTC_BASE + 0x0044))
#define		RTC_AO_GPIO_CTL						((volatile unsigned *)(RTC_BASE + 0x0048))
#define		RTC_AO_ALL_INTR						((volatile unsigned *)(RTC_BASE + 0x004C))
#define		RTC_FREQ_TIMER_VAL					((volatile unsigned *)(RTC_BASE + 0x0050))
...
/* KBS_CTL */
#define KBS_CTL_KEY_EN_MASK                        (0x00000001U)
#define KBS_CTL_KEY_EN_SHIFT                       (0U)
#define KBS_CTL_KEY_AUTOSCAN_EN_MASK               (0x00000002U)
#define KBS_CTL_KEY_AUTOSCAN_EN_SHIFT              (1U)
#define KBS_CTL_KEY_RPRS_RAW_EN_MASK               (0x00000004U)
#define KBS_CTL_KEY_RPRS_RAW_EN_SHIFT              (2U)
#define KBS_CTL_KEY_LPRS_RAW_EN_MASK               (0x00000008U)
#define KBS_CTL_KEY_LPRS_RAW_EN_SHIFT              (3U)
#define KBS_CTL_KEY_PULL_CFG_MASK                  (0x00000010U)
#define KBS_CTL_KEY_PULL_CFG_SHIFT                 (4U)


/* KBS_MASK */
#define KBS_CTL_KEY_ROW_MASK_MASK                        (0x000000FFU)
#define KBS_CTL_KEY_ROW_MASK_SHIFT                       (0U)
#define KBS_CTL_KEY_COL_MASK_MASK                        (0x0000FF00U)
#define KBS_CTL_KEY_COL_MASK_SHIFT                       (8U)


/* KBS_DETECT_INTVAL */
#define KBS_DETECT_KEY_PRS_INTVAL_MASK                (0x000000FFU)
#define KBS_DETECT_KEY_PRS_INTVAL_SHIFT               (0U)
#define KBS_DETECT_KEY_RLS_INTVAL_MASK                (0x0000FF00U)
#define KBS_DETECT_KEY_RLS_INTVAL_SHIFT               (8U)


/* KBS_DBC_INTVAL */
#define	KBS_DBC_KEY_DBC_INTVAL_MASK							(0x000000FFU)
#define	KBS_DBC_KEY_DBC_INTVAL_SHIFT						(0U)	

/* KBS_LPRS_INTVAL */
#define	KBS_LPRS_KBS_RPRS_INTVAL_MASK								(0x000003FFU)
#define	KBS_LPRS_KBS_RPRS_INTVAL_SHIFT							(0U)
#define	KBS_LPRS_KBS_LPRS_INTVAL_MASK								(0x0000FC00U)
#define	KBS_LPRS_KBS_LPRS_INTVAL_SHIFT							(0xaU)


/* KBS_MTXKEY_MANUAL_ROWOUT */
#define KBS_MANUAL_ROWOUT_ROW_SCAN_DRIVE_MASK                   (0x000000FFU)
#define KBS_MANUAL_ROWOUT_ROW_SCAN_DRIVE_SHIFT                  (0U)
#define KBS_MANUAL_ROWOUT_MANUAL_RLS_MASK                       (0x00000100U)
#define KBS_MANUAL_ROWOUT_MANUAL_RLS_SHIFT                      (8U)


/* KBS_MTXKEY_FIFO */
#define	KBS_FIFO_KEY_COL_MASK										(0x00000007U)		
#define	KBS_FIFO_KEY_COL_SHIFT									(0U)
#define	KBS_FIFO_KEY_ROW_MASK										(0x00000070U)
#define	KBS_FIFO_KEY_ROW_SHIFT									(4U)
#define	KBS_FIFO_AL_EMPTY_MASK									(0x00000100U)
#define	KBS_FIFO_AL_EMPTY_SHIFT									(8U)
#define	KBS_FIFO_EMPTY_MASK											(0x00000200U)
#define	KBS_FIFO_EMPTY_SHIFT										(9U)
#define	KBS_FIFO_AL_FULL_MASK										(0x00000400U)
#define	KBS_FIFO_AL_FULL_SHIFT									(0xaU)
#define	KBS_FIFO_FULL_MASK											(0x00000800U)
#define	KBS_FIFO_FULL_SHIFT											(0xbU)
#define	KBS_FIFO_POP_ERROR_MASK									(0x00001000U)
#define	KBS_FIFO_POP_ERROR_SHIFT								(0xcU)
#define	KBS_FIFO_PUSH_ERROR_MASK								(0x00002000U)
#define	KBS_FIFO_PUSH_ERROR_SHIFT								(0xdU)
#define	KBS_FIFO_FLUSH_MASK											(0x00004000U)
#define	KBS_FIFO_FLUSH_SHIFT										(0xeU)


/* KBS_MTXKEY_ASREG0 */
#define	KBS_MTXKEY_AS_ROW0_MASK									(0x000000FFU)
#define	KBS_MTXKEY_AS_ROW0_SHIFT								(0U)
#define	KBS_MTXKEY_AS_ROW1_MASK									(0x0000FF00U)
#define	KBS_MTXKEY_AS_ROW1_SHIFT								(8U)
#define	KBS_MTXKEY_AS_ROW2_MASK									(0x00FF0000U)
#define	KBS_MTXKEY_AS_ROW2_SHIFT								(0x10U)
#define	KBS_MTXKEY_AS_ROW3_MASK									(0xFF000000U)
#define	KBS_MTXKEY_AS_ROW3_SHIFT								(0x18U)


/* KBS_MTXKEY_ASREG1 */
#define	KBS_MTXKEY_AS_ROW4_MASK									(0x000000FFU)
#define	KBS_MTXKEY_AS_ROW4_SHIFT								(0U)
#define	KBS_MTXKEY_AS_ROW5_MASK									(0x0000FF00U)
#define	KBS_MTXKEY_AS_ROW5_SHIFT								(8U)
#define	KBS_MTXKEY_AS_ROW6_MASK									(0x00FF0000U)
#define	KBS_MTXKEY_AS_ROW6_SHIFT								(0x10U)
#define	KBS_MTXKEY_AS_ROW7_MASK									(0xFF000000U)
#define	KBS_MTXKEY_AS_ROW7_SHIFT								(0x18U)


/* KBS_MTXKEY_INT */
#define	KBS_INT_PRS_INT_MASK										(0x00000001U)
#define	KBS_INT_PRS_INT_SHIFT										(0U)
#define	KBS_INT_FIFO_INT_MASK										(0x00000002U)
#define	KBS_INT_FIFO_INT_SHIFT									(1U)
#define	KBS_INT_RPRS_INT_MASK										(0x00000004U)
#define	KBS_INT_RPRS_INT_SHIFT									(2U)
#define	KBS_INT_LPRS_INT_MASK										(0x00000008U)
#define	KBS_INT_LPRS_INT_SHIFT									(3U)
#define	KBS_INT_RLS_MASK												(0x00000010U)
#define	KBS_INT_RLS_SHIFT												(4U)


/* KBS_MTXKEY_INT_RAW */
#define	KBS_INT_RAW_PRS_INT_RAW_MASK						(0x00000001U)
#define	KBS_INT_RAW_PRS_INT_RAW_SHIFT						(0U)
#define	KBS_INT_RAW_FIFO_INT_RAW_MASK						(0x00000002U)
#define	KBS_INT_RAW_FIFO_INT_RAW_SHIFT					(1U)
#define	KBS_INT_RAW_RPRS_INT_RAW_MASK						(0x00000004U)
#define	KBS_INT_RAW_RPRS_INT_RAW_SHIFT					(2U)
#define	KBS_INT_RAW_LPRS_INT_RAW_MASK						(0x00000008U)
#define	KBS_INT_RAW_LPRS_INT_RAW_SHIFT					(3U)
#define	KBS_INT_RAW_RLS_INT_RAW_MASK						(0x00000010U)
#define	KBS_INT_RAW_RLS_INT_RAW_SHIFT						(4U)



/* KBS_MTXKEY_INT_EN */
#define	KBS_INT_PRS_INT_EN_MASK									(0x00000001U)
#define	KBS_INT_PRS_INT_EN_SHIFT								(0U)
#define	KBS_INT_FIFO_INT_EN_MASK								(0x00000002U)
#define	KBS_INT_FIFO_INT_EN_SHIFT								(1U)
#define	KBS_INT_RPRS_INT_EN_MASK								(0x00000004U)
#define	KBS_INT_RPRS_INT_EN_SHIFT								(2U)
#define	KBS_INT_LPRS_INT_EN_MASK								(0x00000008U)
#define	KBS_INT_LPRS_INT_EN_SHIFT								(3U)
#define	KBS_INT_RLS_INT_EN_MASK									(0x00000010U)
#define	KBS_INT_RLS_INT_EN_SHIFT								(4U)

 ...
 *
 * SOURCE CONTROL: $Id: sys_features.h,v 1.269 2014/03/11 03:14:14 garyf Exp $ 
 *
 * LICENCE:
...
#define PRH_BS_CFG_LOCAL_NAME        "Xinc MPW"  //"Ceva XpertBlue"
#endif
...
#define PRH_BS_CFG_LMP_VERSION        LMP_VERSION_BT_4_0
#define PRH_BS_CFG_LMP_SUBVERSION     0x1380
...
#define PRH_BS_CFG_MANUFACTURER_NAME  0x000E
#endif

#define PRH_SYS_CFG_HARDWARE_ADDRESS_FILTERING_SUPPORTED 1
//#if !defined(PRH_BS_CFG_SELECT_LEVEL) 
#ifndef BLUETOOTH_MODE_LE_ONLY
#define PRH_BS_CFG_SELECT_LEVEL      3 /* 0: Headset, 1: V2.1 - min. ACL/SCO buffers, 2:V2.0+EDR, 3: Deployed, 4: V2.1, 5:V3.0+PTA  6:LE only*/
#else
#define PRH_BS_CFG_SELECT_LEVEL      6
#endif//BLUETOOTH_MODE_LE_ONLY
//#endif 

#define mSYSfeatures_Select_Min_Default_Max(cfg_0, cfg_1, cfg_2, cfg_3, cfg_4, cfg_5, cfg_6) \
( (0xFF*(PRH_BS_CFG_SELECT_LEVEL==0) & cfg_0) | (0xFF*(PRH_BS_CFG_SELECT_LEVEL==1) & cfg_1) | \
  ...
  (0xFF*(PRH_BS_CFG_SELECT_LEVEL==6) & cfg_6))

/*
 * LMP Features Bytes 0..2   Configurations(Headset, V2.1 - min. ACL/SCO buffers, V2.0, V4.0, V2.1, V3.0+PTA)
 */

#define PRH_BS_CFG_BYTE_0   mSYSfeatures_Select_Min_Default_Max(0x04, 0xFF, 0xFF, 0x3F, 0xFF, 0xFF, 0x00)  // LC change 0xFF to 0xBF : turn off HOLD.  change 0x3f to 0x00:kick off lmp
#define PRH_BS_CFG_BYTE_1   mSYSfeatures_Select_Min_Default_Max(0xFA, 0xFF, 0xFB, 0xFE, 0xFF, 0xFF, 0x00)  // LC change 0xFF to 0xFE : turn off PARK. FE->AE kick off lmp
#define PRH_BS_CFG_BYTE_2   mSYSfeatures_Select_Min_Default_Max(0x0D, 0x8D, 0x8D, 0x8D, 0x8D, 0x8D, 0x00)
#define PRH_BS_CFG_BYTE_3   mSYSfeatures_Select_Min_Default_Max(0x40, 0xFE, 0xFE, 0xFE, 0xFE, 0xFE, 0x00)
#define PRH_BS_CFG_BYTE_4   mSYSfeatures_Select_Min_Default_Max(0x00, 0x9B, 0x9B, 0xDB, 0x9B, 0x9B, 0x60)  
#define PRH_BS_CFG_BYTE_5   mSYSfeatures_Select_Min_Default_Max(0x00, 0xFF, 0xF9, 0xFD, 0xFF, 0xFF, 0x00)  //
#define PRH_BS_CFG_BYTE_6   mSYSfeatures_Select_Min_Default_Max(0x18, 0x79, 0x00, 0x7B, 0x79, 0x79, 0x40)
#define PRH_BS_CFG_BYTE_7   mSYSfeatures_Select_Min_Default_Max(0x82, 0x83, 0x82, 0x87, 0x83, 0x87, 0x00)

/*
 * PRH Features Bytes 8..13 
 */
#define PRH_BS_CFG_BYTE_8   mSYSfeatures_Select_Min_Default_Max(0x28, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x42) //must support piconet ,mask 0x40
#define PRH_BS_CFG_BYTE_9   mSYSfeatures_Select_Min_Default_Max(0x02, 0xB7, 0xE7, 0xB7, 0xB7, 0xB7, 0x00) // B7->A7 disables test_mode_tester
#define PRH_BS_CFG_BYTE_10  mSYSfeatures_Select_Min_Default_Max(0x5E, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00)
#define PRH_BS_CFG_BYTE_11  mSYSfeatures_Select_Min_Default_Max(0x4B, 0x7F, 0x4F, 0x7F, 0x7F, 0x7F, 0x00)	//7F ->4f kick off lmp
#define PRH_BS_CFG_BYTE_12  mSYSfeatures_Select_Min_Default_Max(0x00, 0x00, 0x07, 0x00, 0x07, 0x07, 0x00) // 07->00 disables lmp_trace	// disable level3 lmp_trace
#define PRH_BS_CFG_BYTE_13  mSYSfeatures_Select_Min_Default_Max(0x00, 0xE4, 0xE4, 0xF4, 0xE4, 0xE4, 0x04) // E4->E0 disables all tci commands
#define PRH_BS_CFG_BYTE_14  mSYSfeatures_Select_Min_Default_Max(0x00, 0x77, 0x77, 0x77, 0x77, 0x77, 0x70)
#define PRH_BS_CFG_BYTE_15  mSYSfeatures_Select_Min_Default_Max(0x00, 0x16, 0x16, 0x36, 0x16, 0x36, 0x00) // 16->36 enables the pta_driver // change 0x16 to 0x36.
...
#if 1 // Below defines should be zero for testing with Beken Agilent tester
...
#define BUILD_TYPE                      GENERIC_BUILD
...
#define PRH_BS_CFG_SYS_TRACE_ADV_VIA_HCI_SUPPORTED 0			//- LC change 1 to 0
...
#define PRH_CFG_MAX_ADV_DIRECT_DUPLICATE_ENTRIES 3
#define PRH_CFG_MAX_ADV_IND_DUPLICATE_ENTRIES 3
#define PRH_CFG_MAX_ADV_SCAN_IND_DUPLICATE_ENTRIES 3
#define PRH_CFG_MAX_ADV_NONCONN_IND_DUPLICATE_ENTRIES 3
#define PRH_CFG_MAX_SCAN_RSP_DUPLICATE_ENTRIES 3
...
#define PRH_BS_CFG_SYS_MAX_WHITE_LIST_ENTRIES 0x06
#else
#define PRH_BS_CFG_SYS_MAX_WHITE_LIST_ENTRIES 0x08
#endif
...
#define PRH_BS_CFG_SYS_CLASSIC_BT_NOT_SUPPORTED_FEATURE      0x0420		//add for LE only
...
#define PRH_BS_CFG_SYS_LMP_MIN_SNIFF_INTERVAL 4
    ...
    #define PRH_BS_CFG_SYS_SIZEOF_HCI_COMMAND_HEAP 0x80//0x200 /* Bytes  */
    #define PRH_BS_CFG_SYS_MAX_HCI_COMMANDS        8
    #define PRH_BS_CFG_SYS_SIZEOF_HCI_EVENT_HEAP   0x100//0x200 /* Bytes  */
    #define PRH_BS_CFG_SYS_MAX_HCI_EVENTS          8

    #define PRH_BS_CFG_SYS_SIZEOF_LMP_IN_HEAP      0x20//0x50  /* Bytes  */
    #define PRH_BS_CFG_SYS_MAX_LMP_IN_MESSAGES     8
    #define PRH_BS_CFG_SYS_SIZEOF_LMP_OUT_HEAP     0x20//0x50  /* Bytes  */
...
#define PRH_BS_CFG_SYS_ESCO_VIA_VCI_SUPPORTED  1   
#else
#define PRH_BS_CFG_SYS_ESCO_VIA_VCI_SUPPORTED 0
#endif
...
#else 
    #define PRH_MAX_DEVICES_SUPPORTED                     9
#endif
/************************/
...
#define MAX_ACTIVE_DEVICE_LINKS         2//PRH_BS_CFG_SYS_MAX_DEVICE_CONTAINERS
...
#else
    #define PRH_BS_CFG_SYS_LOW_POWER_MODE_SUPPORTED 1           // LC turn off LOW_POWER.(0:OFF/1:ON)
#endif
...
#define PRH_BS_CFG_SYS_DEFAULT_WIN_EXT			50

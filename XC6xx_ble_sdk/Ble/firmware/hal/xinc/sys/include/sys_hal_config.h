 ...
 *
 * SOURCE CONTROL: $Id: sys_hal_config.h,v 1.15 2012/02/09 16:38:11 tomk Exp $
 *
 * LICENCE:
 ...
 */
    ...
    #define XStr(x) Str(x)
        ...
        #define __INLINE__ __inline static
    #endif

    #if (!defined(__GNUC__) && (__ARMCC_VERSION >= 4900000))	//- LC change float to integer basis on 'armcc help document'.
...
#define MAX_POWER_LEVEL_1MBITS MAX_POWER_LEVEL_UNITS
#define MIN_POWER_LEVEL_1MBITS 0

#define MAX_POWER_LEVEL_2MBITS MAX_POWER_LEVEL_UNITS
#define MIN_POWER_LEVEL_2MBITS 0

#define MAX_POWER_LEVEL_3MBITS MAX_POWER_LEVEL_UNITS
#define MIN_POWER_LEVEL_3MBITS 0

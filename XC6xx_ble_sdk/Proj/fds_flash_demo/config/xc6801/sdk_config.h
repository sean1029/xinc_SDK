...
#define XINCX_PWM_DEFAULT_CONFIG_OUT0_PIN 4
#endif
...
// <i> XINC_FSTORAGE_FMC uses the xinc_fstorage_sd backend implementation .
// <i> XINC_FSTORAGE_FLASH uses the xinc_fstorage_nvmc implementation.

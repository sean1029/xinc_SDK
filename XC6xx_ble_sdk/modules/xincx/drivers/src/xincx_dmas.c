    ...
    switch(set.ch)
    {
    ...
    #endif  
        {
            ...
            *p_dma_ch_ctl0_base = set.ctl0;
            ...
            printf("addr:%p,DMAS_CHx_SAR:%08x\r\n", p_dma_ch_sar_base,*p_dma_ch_sar_base);
			printf("addr:%p,DMAS_CHx_DAR:%08x\r\n", p_dma_ch_dar_base,*p_dma_ch_dar_base);
			printf("addr:%p,DMAS_CHx_CTL0:%08x\r\n", p_dma_ch_ctl0_base,*p_dma_ch_ctl0_base);
			 printf("addr:%p,DMAS_CHx_CTL1:%08x\r\n", p_dma_ch_ctl1_base ,*p_dma_ch_ctl1_base);

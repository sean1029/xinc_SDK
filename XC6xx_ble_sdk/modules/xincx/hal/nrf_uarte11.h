 ...
 */
__STATIC_INLINE void nrf_uarte_event_clear(XINC_UARTE_Type * p_reg, nrf_uarte_event_t event);
 ...
 */
__STATIC_INLINE bool nrf_uarte_event_check(XINC_UARTE_Type * p_reg, nrf_uarte_event_t event);
 ...
 */
__STATIC_INLINE uint32_t nrf_uarte_event_address_get(XINC_UARTE_Type *  p_reg,
 ...
 */
__STATIC_INLINE void nrf_uarte_shorts_enable(XINC_UARTE_Type * p_reg, uint32_t mask);
 ...
 */
__STATIC_INLINE void nrf_uarte_shorts_disable(XINC_UARTE_Type * p_reg, uint32_t mask);
 ...
 */
__STATIC_INLINE void nrf_uarte_int_enable(XINC_UARTE_Type * p_reg, uint32_t mask);
 ...
 */
__STATIC_INLINE bool nrf_uarte_int_enable_check(XINC_UARTE_Type * p_reg, nrf_uarte_int_mask_t mask);
 ...
 */
__STATIC_INLINE void nrf_uarte_int_disable(XINC_UARTE_Type * p_reg, uint32_t mask);
 ...
 */
__STATIC_INLINE void nrf_uarte_subscribe_set(XINC_UARTE_Type * p_reg,
 ...
 */
__STATIC_INLINE void nrf_uarte_subscribe_clear(XINC_UARTE_Type * p_reg,
                                               nrf_uarte_task_t task);
 ...
 */
__STATIC_INLINE void nrf_uarte_publish_set(XINC_UARTE_Type *  p_reg,
                                           nrf_uarte_event_t event,
                                           uint8_t           channel);
 ...
 */
__STATIC_INLINE void nrf_uarte_publish_clear(XINC_UARTE_Type *  p_reg,
                                             nrf_uarte_event_t event);
 ...
 */
__STATIC_INLINE uint32_t nrf_uarte_errorsrc_get_and_clear(XINC_UARTE_Type * p_reg);
 ...
 * @param p_reg Pointer to the structure of registers of the peripheral.
 */
__STATIC_INLINE void nrf_uarte_enable(XINC_UARTE_Type * p_reg);
 ...
 * @param p_reg Pointer to the structure of registers of the peripheral.
 */
__STATIC_INLINE void nrf_uarte_disable(XINC_UARTE_Type * p_reg);
 ...
 */
__STATIC_INLINE void nrf_uarte_txrx_pins_set(XINC_UARTE_Type * p_reg,
                                             uint32_t         pseltxd,
                                             uint32_t         pselrxd);
 ...
 * @param p_reg Pointer to the structure of registers of the peripheral.
 */
__STATIC_INLINE void nrf_uarte_txrx_pins_disconnect(XINC_UARTE_Type * p_reg);
 ...
 */
__STATIC_INLINE uint32_t nrf_uarte_tx_pin_get(XINC_UARTE_Type * p_reg);
 ...
 */
__STATIC_INLINE uint32_t nrf_uarte_rx_pin_get(XINC_UARTE_Type * p_reg);
 ...
 */
__STATIC_INLINE uint32_t nrf_uarte_rts_pin_get(XINC_UARTE_Type * p_reg);
 ...
 */
__STATIC_INLINE uint32_t nrf_uarte_cts_pin_get(XINC_UARTE_Type * p_reg);
 ...
 */
__STATIC_INLINE void nrf_uarte_hwfc_pins_set(XINC_UARTE_Type * p_reg,
                                             uint32_t         pselrts,
                                             uint32_t         pselcts);
 ...
 * @param p_reg Pointer to the structure of registers of the peripheral.
 */
__STATIC_INLINE void nrf_uarte_hwfc_pins_disconnect(XINC_UARTE_Type * p_reg);
 ...
 * @param task  Task.
 */
__STATIC_INLINE void nrf_uarte_task_trigger(XINC_UARTE_Type * p_reg, nrf_uarte_task_t task);
 ...
 * @return Task address.
 */
__STATIC_INLINE uint32_t nrf_uarte_task_address_get(XINC_UARTE_Type * p_reg, nrf_uarte_task_t task);
 ...
 */
__STATIC_INLINE void nrf_uarte_configure(XINC_UARTE_Type   * p_reg,
 ...
 */
__STATIC_INLINE void nrf_uarte_baudrate_set(XINC_UARTE_Type   * p_reg, nrf_uarte_baudrate_t baudrate);
 ...
 */
__STATIC_INLINE void nrf_uarte_tx_buffer_set(XINC_UARTE_Type * p_reg,
 ...
 */
__STATIC_INLINE uint32_t nrf_uarte_tx_amount_get(XINC_UARTE_Type * p_reg);
 ...
 */
__STATIC_INLINE void nrf_uarte_rx_buffer_set(XINC_UARTE_Type * p_reg,
                                             uint8_t *        p_buffer,
                                             size_t           length);
 ...
 */
__STATIC_INLINE uint32_t nrf_uarte_rx_amount_get(XINC_UARTE_Type * p_reg);
...
__STATIC_INLINE void nrf_uarte_txrx_pins_set(XINC_UARTE_Type * p_reg, uint32_t pseltxd, uint32_t pselrxd)
{
...
__STATIC_INLINE void nrf_uarte_txrx_pins_disconnect(XINC_UARTE_Type * p_reg)
{
    nrf_uarte_txrx_pins_set(p_reg, XINC_UARTE_PSEL_DISCONNECTED, XINC_UARTE_PSEL_DISCONNECTED);
}
...
__STATIC_INLINE void nrf_uarte_hwfc_pins_set(XINC_UARTE_Type * p_reg, uint32_t pselrts, uint32_t pselcts)
{
...
__STATIC_INLINE void nrf_uarte_hwfc_pins_disconnect(XINC_UARTE_Type * p_reg)
{
    nrf_uarte_hwfc_pins_set(p_reg, XINC_UARTE_PSEL_DISCONNECTED, XINC_UARTE_PSEL_DISCONNECTED);
}

...
static uint8_t priv_alloc_base_buf[sizeof(struct sbc_priv) + SBC_ALIGN_MASK];
SBC_EXPORT int sbc_init(sbc_t *sbc, unsigned long flags)
{
	...
	sbc->priv_alloc_base = priv_alloc_base_buf;

...
/**
* @defgroup xinc_memobj Memory Object module
* @{
* @ingroup app_common
...
/**
 * @brief Macro for creating an xinc_memobj pool.
 *
 * This macro declares an xinc_balloc object. The element in the pool contains a user-defined data part and
 ...
 */
typedef xinc_balloc_t xinc_memobj_pool_t;

/**
 * @brief Memory object handle.
 */
typedef void * xinc_memobj_t;
 ...
 * @ref xinc_memobj_write and @ref xinc_memobj_read.
 * 
 * @param[in] p_pool     Pointer to the memobj pool instance structure.
 ...
 * whenever this function is called. @ref xinc_memobj_put function decrements the counter.
 *

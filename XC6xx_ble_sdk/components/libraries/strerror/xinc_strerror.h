...
/**
 * @defgroup xinc_strerror Error code to string converter
 * @ingroup app_common
 *
 ...
 *       For the function that may fail with error translation, see @ref xinc_strerror_find.
 *
 ...
 *
 * This function gets the error string in the same way as @ref xinc_strerror_get,

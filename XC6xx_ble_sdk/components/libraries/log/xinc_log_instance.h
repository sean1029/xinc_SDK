...
#define XINC_LOG_ITEM_DATA(_name)         CONCAT_3(m_xinc_log_,_name,_logs_data)
...
XINC_SECTION_DEF(log_dynamic_data, xinc_log_module_dynamic_data_t);
XINC_SECTION_DEF(log_filter_data, xinc_log_module_filter_data_t);
XINC_SECTION_DEF(log_const_data, xinc_log_module_const_data_t);
/*lint -restore*/
...
//            _CONST xinc_log_module_const_data_t XINC_LOG_ITEM_DATA_CONST(_name)) = {        \
//                .p_module_name   = _str_name,                                             \
//                .info_color_id   = (_info_color),                                         \
//                .debug_color_id  = (_debug_color),                                        \
//                .compiled_lvl    = (xinc_log_severity_t)(_compiled_lvl),                   \
//                .initial_lvl     = (xinc_log_severity_t)(_initial_lvl),                    \
//            }
...
#define XINC_LOG_INTERNAL_ITEM_REGISTER( \
    ...
    XINC_SECTION_ITEM_REGISTER(XINC_LOG_DYNAMIC_SECTION_NAME(_name),                                 \
                    xinc_log_module_dynamic_data_t XINC_LOG_ITEM_DATA_DYNAMIC(_name));               \
    XINC_SECTION_ITEM_REGISTER(XINC_LOG_FILTER_SECTION_NAME(_name),                                  \
                          xinc_log_module_filter_data_t XINC_LOG_ITEM_DATA_FILTER(_name))
...
/**@file
 *
 * @defgroup xinc_log_instance Macros for logging on instance level
 * @{
 * @ingroup xinc_log
 *
...
#define XINC_LOG_INSTANCE_PTR_DECLARE(_p_name) xinc_log_module_dynamic_data_t * _p_name;

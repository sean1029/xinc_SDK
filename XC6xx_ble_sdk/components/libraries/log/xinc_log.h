...
/**@file
 *
 * @defgroup xinc_log Logger module
 * @{
 * @ingroup app_common
 *
 * @brief The xinc_log module interface.
 */
...
#define XINC_LOG_ERROR_STRING_GET(code) xinc_strerror_get(code)
#else
 ...
 *       @ref xinc_log_push call before being processed. For reliable data dumping use

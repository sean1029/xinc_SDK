 ...
 */
__STATIC_INLINE uint32_t xinc_bitmask_bit_is_set(uint32_t bit, void const * p_mask)
{
 ...
 * @param p_mask A pointer to mask with bit fields.
 */
__STATIC_INLINE void xinc_bitmask_bit_set(uint32_t bit, void * p_mask)
{
 ...
 * @param p_mask A pointer to mask with bit fields.
 */
__STATIC_INLINE void xinc_bitmask_bit_clear(uint32_t bit, void * p_mask)
{
    uint8_t * p_mask8 = (uint8_t *)p_mask;
    uint32_t byte_idx = BITMASK_BYTE_GET(bit);
    bit = BITMASK_RELBIT_GET(bit);
 ...
 */
__STATIC_INLINE void xinc_bitmask_masks_or(void const *   p_mask1,
                                          void const *   p_mask2,
                                          void *         p_out_mask,
                                          uint32_t       length)
{
 ...
 * @param length     Length of output mask in bytes.
 */
__STATIC_INLINE void xinc_bitmask_masks_and(void const *   p_mask1,
                                           void const *   p_mask2,
                                           void *         p_out_mask,
                                           uint32_t       length)
{

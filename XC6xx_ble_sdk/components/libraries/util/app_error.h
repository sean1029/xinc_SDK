...
#define XINC_FAULT_ID_SDK_ASSERT      (XINC_FAULT_ID_SDK_RANGE_START + 2) /**< An error stemming from a call to ASSERT (xinc_assert.h). The info parameter is a pointer to an @ref assert_info_t variable. */
/**@} */
